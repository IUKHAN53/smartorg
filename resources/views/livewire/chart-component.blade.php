<div>
    @if($jsonData)
        <div class="my-orgchart-wrapper max-w-7xl mx-auto">
            <!-- Top Bar -->
            <div class="my-orgchart-topbar flex items-center justify-between mb-3 border-b border-gray-200 pb-3">
                <h2 class="my-orgchart-title text-xl font-semibold">Organization Chart</h2>
                <div class="my-orgchart-search flex items-center space-x-2">
                    ...
                    <input
                        type="text"
                        class="my-orgchart-search-input form-input border border-gray-300 rounded px-2 py-1 focus:outline-none focus:ring-1 focus:ring-blue-500"
            ...
            <div class="my-orgchart-container border border-gray-200 rounded-md p-4 bg-gray-50"></div>
            <div
                id="myOrgChartNodeModal"
                class="my-orgchart-modal hidden fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex items-center justify-center z-50"
            >
